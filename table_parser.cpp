...
void Table_parser::init(QString str)
{
    QString slr;
...
void Table_parser::run(QString str1)
{
    this->counter++;
    this->flag=0;
...
void Table_parser::adjuster(QString str, int c, int d){
    this->k++;
...
void Table_parser::runner(int v)
{
    if(v==0){
